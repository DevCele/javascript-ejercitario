...
// 2.2 Escribe una función llamada `saludarPersonalizado` que reciba dos parámetros: `nombre` y `apellido`. La función debe devolver "Hola, [nombre] [apellido]".
    ...
    saludarPersonalizado("Celeste", "Jimenez") // Imprime Hola, Celeste Jimenez
...
// 2.3 Crea una función llamada `calcularPotencia` que reciba dos parámetros: base y exponente. La función debe devolver el resultado de elevar la base al exponente.
    ...
    console.log(calcularPotencia(5, 2)) // Imprime 25 
    console.log(calcularPotencia(4, 5)) // Imprime 1024
...
console.log(restar(4, 5)) // Imprime -1
...
console.log(dividir(255, 5)) // Imprime 51
console.log(dividir(4, 2)) // Imprime 2
...
console.log(fibonacci(7)); // Imprime 13
...
console.log(factorial(9)); //Imprime 362880
...
function potencia(base, exponente) {
    if(exponente === 0){
        return 1
    } else if (exponente < 0) { // Si el exponente es negativo, se calcula la potencia como 1/potencia(base, -exponente)
        return 1 / potencia(base, -exponente);
    }
    return base * potencia(base, exponente - 1); // Llamada recursiva
}
console.log(potencia(5, 2)) // Imprime 25
